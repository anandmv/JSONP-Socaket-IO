...
Socket.prototype.to = Socket.prototype.in = function (id) {
  this.timestamp.id = id;
  return this;
};

Socket.prototype.to = Socket.prototype.in = function (id) {
  this.update(this.timestamp.id );
  return this;
};
Socket.prototype.to = Socket.prototype.in = function (id) {
...
Socket.prototype.to = Socket.prototype.in = function (id,timestamp) {
  
  this.msg.push(id,timestamp);
  return this;
};
Socket.prototype.to = Socket.prototype.in = function () {
